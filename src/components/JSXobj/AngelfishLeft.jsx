...
export default function AngelfishLeft(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('./obj/angelfishLeft.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature" scale={0.54} />
        <group name="Armature001" position={[0.02, 0.25, 0.04]} rotation={[Math.PI, 0, Math.PI]}>
...
useGLTF.preload('./obj/angelfishLeft.gltf')
